  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='fuwuyuan'" class="input-group">
			   <div class="label">员工工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yuangonggonghao" class="input" type="text" placeholder="员工工号">
			   </div>
			 </div> -->
			<el-form-item label="员工工号" class="input" v-if="tableName=='fuwuyuan'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='fuwuyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='fuwuyuan'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="员工姓名" class="input" v-if="tableName=='fuwuyuan'">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='fuwuyuan'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
			<!-- <div v-if="tableName=='fuwuyuan'" class="input-group">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='fuwuyuan'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.yuangonggonghao) && `fuwuyuan` == this.tableName){
        this.$message.error(`员工工号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `fuwuyuan` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `fuwuyuan` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.yuangongxingming) && `fuwuyuan` == this.tableName){
        this.$message.error(`员工姓名不能为空`);
        return
      }
      if(`fuwuyuan` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
