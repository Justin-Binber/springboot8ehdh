<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="点歌时间" prop="diangeshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.diangeshijian" 
                type="datetime"
                :readonly="ro.diangeshijian"
                placeholder="点歌时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.diangeshijian" label="点歌时间" prop="diangeshijian">
              <el-input v-model="ruleForm.diangeshijian" 
                placeholder="点歌时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yonghuxingming = true;
          ...
          if(o=='diangeshijian'){
            this.ruleForm.diangeshijian = obj[o];
	    this.ro.diangeshijian = true;
            continue;
          }
          if(o=='userid'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `diangeyuyue/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.diangeyuyueCrossAddOrUpdateFlag = false;
						 this.parent.search();
