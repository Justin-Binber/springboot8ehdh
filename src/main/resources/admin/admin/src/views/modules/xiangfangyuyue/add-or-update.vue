<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="厢房号" prop="xiangfanghao">
          <el-input v-model="ruleForm.xiangfanghao" 
              placeholder="厢房号" clearable  :readonly="ro.xiangfanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="厢房号" prop="xiangfanghao">
              <el-input v-model="ruleForm.xiangfanghao" 
                placeholder="厢房号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="厢房类型" prop="xiangfangleixing">
          <el-select :disabled="ro.xiangfangleixing" v-model="ruleForm.xiangfangleixing" placeholder="请选择厢房类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="厢房类型" prop="xiangfangleixing">
	      <el-input v-model="ruleForm.xiangfangleixing"
                placeholder="厢房类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuyuebianhao = true;
          ...
          if(o=='xiangfanghao'){
            this.ruleForm.xiangfanghao = obj[o];
	    this.ro.xiangfanghao = true;
            continue;
          }
          if(o=='xiangfangleixing'){
            this.ruleForm.xiangfangleixing = obj[o];
	    this.ro.xiangfangleixing = true;
            continue;
          }
          if(o=='jiage'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xiangfangyuyue/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xiangfangyuyueCrossAddOrUpdateFlag = false;
						 this.parent.search();
