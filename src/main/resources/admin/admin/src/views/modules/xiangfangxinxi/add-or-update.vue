<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="厢房类型" prop="xiangfangleixing">
          <el-input v-model="ruleForm.xiangfangleixing" 
              placeholder="厢房类型" clearable  :readonly="ro.xiangfangleixing"></el-input>
        </el-form-item>
        <div v-else>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xiangfangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xiangfangxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
